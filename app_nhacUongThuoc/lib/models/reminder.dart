...
class Reminder {
  ...
  final DateTime? selectedDate; // Ngày cụ thể cho "Một lần"
  ...
  factory Reminder.fromMap(Map<String, dynamic> map) {
    ...
    if (map['selected_date'] != null && map['selected_date'].toString().isNotEmpty) {
      try {
        parsedSelectedDate = DateTime.parse(map['selected_date'] as String);
      } catch (e) {
  ...
  bool isActiveOnDate(DateTime date) {
    ...
    // Các chế độ khác chỉ cần kiểm tra day of week
    final dayOfWeek = date.weekday == 7 ? 6 : date.weekday - 1;
